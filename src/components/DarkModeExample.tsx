      ...
      <div className="space-y-4">
        ...
        <div className={`p-4 rounded-lg border ${themeClasses}`}>
          ...
          <div className="space-y-1 text-sm">
            <div><strong>User Preference:</strong> {theme}</div>
            <div><strong>Resolved Theme:</strong> {resolvedTheme}</div>
            <div><strong>Is Dark Mode:</strong> {isDark ? 'Yes' : 'No'}</div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <ForceTheme theme="light">
              <div className="bg-white text-black p-4 rounded-lg border border-gray-300">
                ...
                <p className="text-sm">This section is always light, regardless of user preference.</p>
              </div>
            </ForceTheme>
            ...
            <ForceTheme theme="dark">
              <div className="bg-dark-surface text-dark-text p-4 rounded-lg border border-dark-border">
                ...
                <p className="text-sm">This section is always dark, regardless of user preference.</p>
              </div>
            </ForceTheme>
          </div>
        </div>
        ...
        <div className={`p-4 rounded-lg border ${themeClasses}`}>
          ...
          <p className="text-sm">
            ...
            <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">useThemeClasses</code> hook.
          </p>
        </div>
      </div>
    </div>
